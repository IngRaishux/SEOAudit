          ...
          <div className="bg-white dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-800">
            ...
            <div className="p-6">
              <div className="space-y-4">
                ...
                <div>
                  <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-1">Organizations</p>
                  <p className="text-zinc-900 dark:text-white font-medium">
                    {session.user.organizations?.length || 0} organization{(session.user.organizations?.length || 0) !== 1 ? 's' : ''}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-zinc-600 dark:text-zinc-400">
                    Receive notifications about your organizations and sites
                  </p>
                </div>
                <input
                  type="checkbox"
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-zinc-600 dark:text-zinc-400">
                    Receive weekly SEO analysis reports
                  </p>
                </div>
                <input
                  type="checkbox"
